...
declared in Lume: `annotation JsonName`, `annotation JsonIgnore`, and
`single Json`. Low-level escaping, collection traversal, and reflection caching
live in the small JVM bridge used by that Lume facade.
